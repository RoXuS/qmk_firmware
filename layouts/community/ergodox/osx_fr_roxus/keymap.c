...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        // left hand
        FR_AT,          FR_AMP,      FR_EACU,       FR_QUOT, FR_APOS, FR_LPRN, KC_LEFT,
        KC_TAB,          FR_A,        FR_Z,          KC_E,    KC_R,    KC_T,    TG(1),
        KC_ESC,          FR_Q,        KC_S,          KC_D,    KC_F,    KC_G,
        KC_LSFT,         FR_W,        KC_X,          KC_C,    KC_V,    KC_B,    LCA(KC_F),
        FR_LESS,         KC_LCTRL,    KC_LALT,       KC_LGUI, LSFT(FR_LESS),
            LSFT(FR_MINS), FR_LPRN,
            FR_LBRC,
            KC_SPC, KC_DELT, FR_LCBR,
        ...
        SGUI(KC_F),   KC_N,    FR_COMM, FR_SCLN,           FR_COLN, FR_EQL,          FR_TILD,
        KC_UP,        KC_DOWN, KC_LBRC, KC_RBRC,           FR_UGRV,
            FR_RPRN, FR_MINS,
            FR_RBRC,
            FR_RCBR, KC_BSPC, KC_ENT
    ),
